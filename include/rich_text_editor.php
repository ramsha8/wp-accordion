...
<div class="editor-container">
  <button type="button" onClick="toggleButtonfunc.call(this)" class="toggle-button">Source Editor</button>
    <div class="output-panel">
    <div class="output" oninput="outputHtmlRender.call(this)"  contenteditable="true"><?php echo isset($accordion_explanation)?stripslashes(htmlspecialchars_decode($accordion_explanation)): $detail; ?></div>
  </div>
